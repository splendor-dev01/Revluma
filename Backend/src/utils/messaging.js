                  ...
                  <tr>
                    <td style="padding: 20px 40px 40px;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 30px;">
                        <tr>
                          <td align="center">
                            <a href="${process.env.FRONTEND_URL || 'https://splendor.ai'}/auth/onboarding.html" style="display: inline-block; background-color: #ffffff; color: #0a0a0a; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">Complete Your Setup</a>
                          </td>
                        </tr>
                      </table>
